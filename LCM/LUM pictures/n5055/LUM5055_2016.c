...
//
{
    ...
    a2tree->ReadFile("NGC5055_deBlok_DISKdf.txt", "kt:lum2");
    cout << "N5055Reported tree has " << a2tree->GetEntries() << " entries" << endl;
    
    // ***** Set alpha filename here ***** //
    a5tree->ReadFile("n5055_disk_XueSofue.txt", "kt:lum5");
    cout << "XueSof tree has " << a5tree->GetEntries() << " entries" << endl;
    
    // ***** Set alpha filename here ***** //
    a1tree->ReadFile("n5055_disk_AB.txt", "kt:lum1");
    ...
    leg->SetFillColor(0);
    leg->AddEntry(a2graph, "Reported Disk Profile deBlok ", "l");
