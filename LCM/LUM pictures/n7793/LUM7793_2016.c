...
//
{
   ...
   a2tree->ReadFile("NGC7793_DicaireISO_DISK.txt", "kt:lum2");
    cout << "NGC7814 Reported tree has " << a2tree->GetEntries() << " entries" << endl;
    
    // ***** Set alpha filename here ***** //
    a5tree->ReadFile("NGC7793_LCM_disk_goodXS.txt", "kt:lum5");
    cout << "anatA tree has " << a5tree->GetEntries() << " entries" << endl;
    
    // ***** Set alpha filename here ***** //
    a1tree->ReadFile("NGC7793_LCM_disk_goodAB.txt", "kt:lum1");
    ...
    leg->SetFillColor(0);
    leg->AddEntry(a2graph, "Reported Disk Profile DiCaire ", "l");
