...
//
{
    ...
    leg->SetFillColor(0);
    leg->AddEntry(a2graph, "Reported Luminous Profile TaM James ", "l");
    leg->AddEntry(a5graph, "XueSofue", "l"); 
    leg->AddEntry(a1graph, "Klypin (2002) model B   ", "l");
    leg->AddEntry(a9graph, "Reported Luminous Profile MOND Bottema   ", "l");
    leg->Draw();
