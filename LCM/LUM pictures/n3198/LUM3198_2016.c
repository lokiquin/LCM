...
//
{
    ...
    a2tree->ReadFile("DISK_N3198co.txt", "kt:lum2");
    cout << "N2903Reported tree has " << a2tree->GetEntries() << " entries" << endl;
    
    // ***** Set alpha filename here ***** //
    a5tree->ReadFile("n3198_MeaganXueSofue.txt", "kt:lum5");
    cout << "XueSof tree has " << a5tree->GetEntries() << " entries" << endl;
    
    // ***** Set alpha filename here ***** //
    a1tree->ReadFile("n3198_MeaganAnatolyB.txt", "kt:lum1");
    ...
    leg->SetFillColor(0);
    leg->AddEntry(a2graph, "Reported Luminous Profile DeBlok ", "l");
