...
//
{
    ...
    leg->SetFillColor(0);
    leg->AddEntry(a2graph, "Reported Disk Profile McGaugh ", "l");
    leg->AddEntry(a5graph, "LCM Disk Profile for MW XueSofue", "l"); 
    leg->AddEntry(a1graph, "LCM Disk Profile for MWKlypin (2002) model B   ", "l");
    leg->Draw();
